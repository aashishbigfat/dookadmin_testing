        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td>
                            <div class="img"><img src="{{public_path('media/itinerary/package.png')}}" alt="icon"></div>
                        </td>
            ...
            <td>
                <table>
                    <tr>
                        <td>
                            <div class="img"><img src="{{public_path('media/itinerary/time.png')}}" alt="icon"></div>
                        </td>
        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td>
                            <div class="img"><img src="{{public_path('media/itinerary/calendar.png')}}" alt="icon"></div>
                        </td>
            ...
            <td>
                <table>
                    <tr>
                        <td>
                            <div class="img"><img src="{{public_path('media/itinerary/route.png')}}" alt="icon"></div>
                        </td>
            ...
            @foreach($pkg_pois as $key => $pkg_poi)
                ...
                <td class="top">
                    <table>
                        <tr>
                            <td class="top">
                                <div class="img t_img" style="background-image: url('dook/{{$pkg_poi->image}}');"></div>
                            </td>
                            <td class="top">
