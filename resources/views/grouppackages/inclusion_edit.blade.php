...
@section('headSection')
@section('title', 'Group Tours | Inclusions Update')
...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route('group_dates',request()->route('id'))}}">Group Tours Date Wise </a></li>
        <li class="active">Edit Inclusions</li>
      </ol>
    </section>
    ...
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('group_date_inclusion_update',request()->route('date_id')) }}",
