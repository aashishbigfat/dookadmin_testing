...
@section('headSection')
@section('title', 'Group Tours | Visa Informations')
...
<div class="content-wrapper">
    <section class="content-header">
      <h1>Group Tours - Visa Informations</h1>
      <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{route('group_packages')}}">Package</a></li>
    ...
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('group_visa_informations_update',request()->route('id')) }}",
                    data: formDatas,
                    contentType: false,
                    processData: false,
