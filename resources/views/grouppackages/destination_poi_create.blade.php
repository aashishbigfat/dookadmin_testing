...
<div class="content-wrapper">
                  ...
                  <label>Destinations</label> <span class="validationError" id="destinations_error"></span>
                    <select class="form-control destinations" name="destinations" id="destinations">
                     ...
                     @foreach($destinations as $destination)
                        <option value="{{$destination->id}}" data-dookdestid="{{$destination->id}}" data-id="{{$destination->reference_id}}" data-countryreffid="{{$destination->country_reference_id}}" data-destname="{{$destination->dest_name}}" data-countryname="{{$destination->country_name}}"  data-region="{{$destination->region}}" data-lat="{{$destination->latitude}}" data-long="{{$destination->longitude}}" data-fclass="{{$destination->feature_class}}" data-fcode="{{$destination->feature_code}}" data-iso="{{$destination->country_iso_3}}" data-routeId="{{ request()->route('id') }}">{{$destination->dest_name}} ({{$destination->country_name}})</option>
                      @endforeach
      ...
      <div class="box">
        <div class="box-header with-border">
            ...
            <div class="ItninerarListing" id="PoiListing">
              @include('grouppackages/destination_poi_list')
        </div>
      </div>
    </section>
  </div>
  ...
  @section('footerSection')
    <div class="modal fade" id="addMorePois" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog modal-xl" role="document" style="width: 55%">
                <div class="modal-content">
                    <div class="modal-header col-md-12">
                          <div class="col-md-6"><h5 class="modal-title" id="exampleModalLabel">Add More Poi</h5></div>
                  ...
                  <div class="itinerary-setup m-t-20">
                   <div class="days" style="margin:-10px">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-xs-12 sss">
                      <div class="form-group">
                        <input type="hidden" class="form-control" name="dep_type" id="dep_type" value="group">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-xs-12 sss">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="add_description" id="add_description" style="height: 100px"></textarea>
                      </div>
                    </div>
                ...
                <div class="modal-content">
                   ...
                   <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 col-xl-6 sss">
                    ...
                    <label>Destinations</label> <br>
                      <select class="form-control edit_destinations" name="edit_destinations" id="edit_destinations">
                       @foreach($destinations as $destination)
                          <option value="{{$destination->id}}">{{$destination->dest_name}} ({{$destination->country_name}})</option>
                        @endforeach
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                    ...
                    <label>POI Name</label><br>
                      <input type="text" class="form-control" name="edit_poi" id="edit_poi" style="width: 100%;">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                    ...
                    <label>Experiences</label><br>
                      <select class="form-control edit_experiences" name="edit_experiences[]" id="edit_experiences" multiple="">
                      </select>
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8 col-lg-8 col-xl-8" style="margin-top: 10px">
                      <div class="form-group">
                        <label>POI Banner Image <span style="color: #9a191e">(W:1920, H:1080)</span></label><span class="validationError" id="add_image_error_banner"></span>
    ...
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('group_packages_poi_store',request()->route('id')) }}",
        ...
        $(".disablepoi").click(function () {
          ...
          var token = $("meta[name='csrf-token']").attr("content");
            if (confirm("Are you sure you want to "+flag+" this POIs?"))
              $.ajax(
              {
                url: '/group-package-poi-disable/' + id,
                type: 'POST',
                data: {
                    "id": id,
                    "_token": token,
    ...
    $(document).ready(function () {
            $('#update_Pois').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: '/group-package/poi/update/' + edit_id,
                    data: formDatas,
                    contentType: false,
                    processData: false,
                    success: function (data) {
  ...
  <script>
   // var experienceID = [];
    $('.destinations').change(function(){
      ...
      //var destID = $(this).find(':selected').attr('data-id');
