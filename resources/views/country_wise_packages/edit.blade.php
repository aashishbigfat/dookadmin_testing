...
<div class="content-wrapper">
    <section class="content-header">
      <h1>Edit Country Wise Package</h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
         <div class="row">
            <form action="{{ route('country-wise-packages.update', $countryWisePackage->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                @include('country_wise_packages.form', ['package' => $countryWisePackage])
