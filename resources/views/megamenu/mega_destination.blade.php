...
@section('headSection')
@section('title', 'Mega Menu Destinations')
<link rel="stylesheet" href="{{asset('css/customCSS/top_destination.css')}}">
@endsection
@section('main-content')
<div class="content-wrapper">
    <section class="content-header">
      <h1>Mega Menu Destinations</h1>
      <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Mega Menu Destinations</li>
      </ol>
    </section>
      ...
      <div class="row DestinationCountryBox">
        ...
        <div class="col-md-8">
          <div class="box-header with-border">
            <span style="font-size: 16px;font-weight: 600;">Mega Menu Destinations</span>
                ...
                @if(count($destinations)> 0 )
                  @foreach( $destinations as $key => $value )
                    <tr id="{{ $value->id }}">
                      ...
                      <td>{{$value->country}}</td>
                      <td>
                        <a class="popularDest" data-id="{{ $value->id }}" title="Delete Mega Destination?" style="cursor: pointer;">
  ...
  <style type="text/css">
    .DestinationCountryBox .col-md-8{box-shadow: 3px 2px 4px 0 #a55a5a;background: #fff;}.box-footer{border-top: none;background-color: transparent;}
  </style>
  @endsection
 ...
 <script>
  ...
  <script type="text/javascript">
    $(".popularDest").click(function () {
      ...
      $.ajax(
        {
          url: '/megamenu-destination/disable/' + id,
          type: 'POST',
          data: {
              "id": id,
              "_token": token,
    ...
    $(document).ready(function () {
      ...
      $('#store_form').click(function (e) {
          ...
          $.ajax({
              ...
              method: 'POST',
              url: "{{ route('mega_destination_store') }}",
              data: formDatas,
              contentType: false,
              processData: false,
              success: function (data) {
