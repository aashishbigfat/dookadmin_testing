<div class="design_1 fix_pdf_container banner_detail">
    ...
    <div class="company_name">
        <img src="https://www.dookinternational.com/assets/images/logo.png" alt="company-logo">
        <h1>{{$banner_data->company_name}}</h1>
    </div>
    <table class="company_contact">
        @if($banner_data->contact_no != '')
        <tr>
            <td><div class="img"><img src="{{asset('media/itinerary/phone.png')}}" alt="icon"></div></td>
            <td><a href="tel:{{$banner_data->contact_no}}">{{$banner_data->contact_no}}</a></td>
        </tr>
        @endif
        @if($banner_data->whatsapp_no != '')
        <tr>
            <td><div class="img"><img src="{{asset('media/itinerary/whatsapp.png')}}" alt="icon"></div></td>
        ...
        <tr>
            <td><div class="img"><img src="{{asset('media/itinerary/email.png')}}" alt="icon"></div></td>
            <td><a href="mailto:{{$banner_data->email}}">{{$banner_data->email}}</a></td>
        </tr>
        @endif
        @if($banner_data->website != '')
        <tr>
            <td><div class="img"><img src="{{asset('media/itinerary/website.png')}}" alt="icon"></div></td>
