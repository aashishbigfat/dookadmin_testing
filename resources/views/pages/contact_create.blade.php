        ...
        <form role="form" id="FooterForm">
          @csrf
            <div class="box-body">
              ...
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="header_title" id="header_title">
                </div>
              </div>
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
                  <label>Header Sub Title</label>
                  <input type="text" class="form-control" name="header_subtitle" id="header_subtitle">
                </div>
              </div>
            ...
            <div class="box-body" style="margin-top: 15px">
              <div class="col-md-4 col-lg-4 col-sm-12">
                <div class="form-group">
                  <label class="fbm_images" for="exampleInputFile">Banner Image <span style="color: #9a191e">(W:1920, H:300)</span></label> <span class="validationError" id="page_banner_error"></span> 
              ...
              <div class="row wrappers">
                  <div class="col-md-4">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control pull-right" value="" name="addressTitle[]" id="addressTitle" autocomplete="off">
                      </div>
                  </div>
                  ...
                  <div class="col-md-2 d-flex justify-content-between" style="margin-top: 25px;">
