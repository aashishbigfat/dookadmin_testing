...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route('landing_pages')}}">Landing Pages</a></li>
                ...
                <div class="form-group">
                  <label>Page Type <sup>*</sup></label> <span class="validationError" id="pageTypes_error"></span>
                    <select class="form-control pageTypes" name="pageTypes" id="pageTypes">
                      <option value="landing_departure">Landing International Tour</option>
                      <option value="landing_domestic">Landing Domestic Tour</option>
                      <option value="landing_group_tours">Landing Group Tour</option>
                      <option value="landing_experience">Landing Experience</option>
                      <option value="landing_destination">Landing Destination</option>
                      
                      <option value="landing_country">Landing Country</option>
                      <option value="landing_region">Landing Region</option>
                      
                      <option value="landing_activity">Landing Activity</option>
                      <option value="landing_career">Landing Career</option>
                      <option value="landing_review">Landing Review</option>
                      <option value="landing_privacy">Landing Privacy</option>
                      <option value="landing_terms_conditions">Landing Terms & Conditions</option>
                      <option value="landing_presentation">Landing Presentation</option>
                      <option value="landing_faqs">Landing FAQs</option>
                    </select>
                </div>
              </div>
              <div class="col-md-6 col-lg-6 col-sm-12">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                if (pageTypes == "") {
                    $("span#pageTypes_error").html('This field is required!');
                    $("select#pageTypes").focus();
                    return false;
                }
                var title = $('#title').val();
                if (title == "") {
