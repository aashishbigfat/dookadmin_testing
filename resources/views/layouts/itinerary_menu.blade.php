<ul role="tablist" class="tabclass" style="margin-bottom: 30px;">
  @if(request()->route('id'))
    <li class="tab-departure">
      <a class="btn btn-primary not-active0 btns" href="{{route('departure_edit',request()->route('id'))}}">
        <span class="Dep_basic_details step">Basic Details</span>
      </a>
    </li>
    <!-- <li class="tab-departure">
      <a class="btn btn-primary not-active1 btns" href="{{route('departure_inclusion',request()->route('id'))}}">
        <span class="inclusions step">Inclusions</span>
      </a>
    </li> -->
   <li class="tab-departure">
      <a class="btn btn-primary not-active2 btns" href="{{route('departure_poi_create',request()->route('id'))}}">
        <span class="inclusions step">Point of Interests</span>
      </a>
    </li>
    <li class="tab-departure">
      <a class="btn btn-primary not-active03 btns" href="{{route('departure_activities',request()->route('id'))}}">
        <span class="inclusions step">Activities</span>
      </a>
    </li>
    <li class="tab-departure">
      <a class="btn btn-primary not-active4 btns" href="{{route('departure_itinerary_create',request()->route('id'))}}">
        <span class="itineraries step">Itinerary</span>
      </a>
    </li>
    <li class="tab-departure">
      <a class="btn btn-primary not-active5 btns" href="{{route('departure_term_conditions',request()->route('id'))}}">
        <span class="term&condition step">Terms & Conditions</span>
      </a>
    </li>
    {{--
{{--<li class="tab-departure">
      <a class="btn btn-primary not-active6 btns" href="{{route('departure_visa_informations',request()->route('id'))}}">
        <span class="visainfo step">Visa Informations</span>
      </a>
    </li> --}}
    <li class="tab-departure">
      <a class="btn btn-primary not-active7 btns depDates" href="{{route('departure_dates',request()->route('id'))}}">
        <i class="fa fa-calendar" style="color:#d3e918"></i>
        <span class="inclusioninfo step">Departure Dates</span>
      </a>
    </li>
    <li class="tab-departure">
      <a class="btn btn-primary not-active6 btns" href="{{route('departure_pdf_create',request()->route('id'))}}">
        <span class="hotelcat step">Create Pdf</span>
      </a>
    </li>
  @else
    <li class="tab-departure active">
      <a class="btn btn-primary not-active0 btns" href="#">
        <span class="Dep_basic_details step">Basic Details</span>
      </a>
    </li>
...
{{--<li class="tab-departure not-active2">
    ...
    <li class="tab-departure not-active2 btns">
      <a class="btn btn-primary rrmenu" href="#">
        <i class="fa fa-calendar" style="color:#d3e918"></i> <span class="itineraryinfo step">Departure Dates</span>
      </a>
    </li>
  @endif
</ul>
