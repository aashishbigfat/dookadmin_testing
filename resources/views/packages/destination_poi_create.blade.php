...
@section('headSection')
@section('title', 'Packages | Point of Interest')
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <div class="ItninerarListing" id="PoiListing">
              @include('packages/destination_poi_list')
            </div>
                   ...
                   <div class="days" style="margin:-10px">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-xs-12 sss">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="add_description" id="add_description" style="height: 80px"></textarea>
                      </div>
                    </div>
    ...
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('packages_poi_store',request()->route('id')) }}",
    ...
    $(document).ready(function () {
            $('#update_Pois').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: '/packages/poi/update/' + edit_id,
                    data: formDatas,
                    contentType: false,
                    processData: false,
                    success: function (data) {
