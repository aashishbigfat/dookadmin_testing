          ...
          <div class="box-body">
            ...
            <div class="col-md-6">
              <div class="checkbox all">
                <label style="font-size: 18px;color: #e01a1a;"><input type="checkbox" id="checkAll" name="destCheckUncheck" value="NoUpdate" class="destCheckUncheck">Checked if you want to Add & Update Destinations Section</label>
              </div>
            </div>
          </div>
            <div class="box-body">
              ...
              <div class="col-md-2 col-lg-2 col-sm-12">
                <div class="form-group">
                <label>Currency Symbol (INR)</label> <span class="validationError" id="currency_symbol_error"></span>
                  <select class="form-control select2" name="currency_symbol" id="currency_symbol">
                   <option value="{{$symbols->currency_symbol}}">{{$symbols->currency_symbol}}({{$symbols->currency}})</option>
                  </select>
                </div>
              </div>
              <div class="col-md-2 col-lg-2 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="price" id="price" value="{{$departures->price}}">
                </div>
              </div>
                {{-- Anirudh start --}}
              <div class="col-md-2 col-lg-2 col-sm-12">
                <div class="form-group">
                  <label>Valid Till</label><span class="validationError" id="valid_date_error"></span>
                  <input type="date" class="form-control" name="valid_till" id="valid_till" value="{{$departures->valid_till}}">
                </div>
              </div>
              {{-- Anirudh end --}}
              <!-- Dollar Currency -->
               <div class="col-md-2 col-lg-2 col-sm-12">
                <div class="form-group">
                <label>Currency Symbol (USD)</label> <span class="validationError" id="currency_symbol_usd_error"></span>
                  <select class="form-control select2" name="currency_symbol_usd" id="currency_symbol_usd">
                   <option value="{{$symboldollar->currency_symbol}}">{{$symboldollar->currency_symbol}}({{$symboldollar->currency}})</option>
                  </select>
                </div>
              </div>
              <div class="col-md-2 col-lg-2 col-sm-12">
            ...
            <div class="form-group">
              <label>Price Tag</label><span class="validationError" id="price_tag_error"></span>
              <input type="text" class="form-control" name="price_tag" id="price_tag"
                value="{{ $departures->price_tag }}">
            </div>
          </div>
              <div class="col-md-3 col-lg-3 col-sm-12">
              ...
              <div class="col-md-12 col-lg-12 col-sm-12" style="margin-top: 20px">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="description" id="description" style="height: 200px">{{$departures->description}}</textarea>
                </div>
              </div>
              <div class="box-body">
              ...
              <div class="col-md-3" style="margin-top: 20px">
                <input type="hidden" name="package_multi_img"  id="j_son" disabled>
                 <label class="fbm_images" for="exampleInputFile">Upload Images (4 Images*)</label>
                <div class="form-group">
                  <div class="input-group">
...
<style>
  ...
  .DestinationSearchChecked{cursor: not-allowed;filter: alpha(opacity=65);-webkit-box-shadow: none;box-shadow: none;opacity: .65;}#checkAll{width: 20px;height: 20px;margin-left: -24px;}.btn-checkbox {}
  ...
  <script>
    $( document ).ready(function() {
      ...
      $('#price').keyup(function(){
        ...
        if(price){
        var result = Math.floor(price / default_inr);
  ...
  <script>
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                // if (valid_till == "") {
                //   $("span#destinations_error").hide();
                //     $("span#valid_date_error").html(' This field is required!');
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('packages_update',request()->route('id')) }}",
                    data: formDatas,
                    contentType: false,
                    processData: false,
