...
@section('headSection')
@section('title', 'Package | Day Wise Itinerary')
...
<div class="content-wrapper">
    <section class="content-header">
      <h1>Day Wise Itinerary Create</h1>
      <ol class="breadcrumb">
        ...
        @if($itinerary <= $tour)
            ...
            @csrf
              ...
              <div class="box-body">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 button-submit">
                  <button class="btn btn-primary active" type="button" id="store_form"> <span class="crop_text"><i class="fa fa-save"></i> Save</span>
          ...
          @else
           <div class="col-md-12" style="margin-bottom: 10px">
            <h4>Itinerary details for all days has been completed</h4>
          </div>
        @endif
      </div>
      <div class="box">
        ...
        <div class="ItninerarListing">
          @include('packages/itinerary_list')
        </div>
    ...
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('packages_itinerary_store',request()->route('id')) }}",
        ...
        $(".disableItinerary").click(function () {
          var id = $(this).data("id");
            ...
            if (confirm("Are you sure you want to delete this Itinerary?"))
              $.ajax(
              {
                url: '/packages-itinerary-disable/' + id,
                type: 'POST',
                data: {
                    "id": id,
                    "_token": token,
                ...
                success: function (data) {
                  alert("Itinerary delete successfully!!");
...
<script>
     $('.edit-item').on('click', function() {
      $('#edit-item').modal('show');
            ...
            var inclusionID = $(this).data('inclusion');
...
<script type="text/javascript">
    $(document).ready(function () {
            $('#update_itinerary').click(function (e) {
                ...
                // var destinations = $('#edit_pois').val();
                // if (destinations == "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: '/packages/itinerary/update/' + edit_id,
