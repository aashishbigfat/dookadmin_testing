...
<head>
    ...
    <style>
        ...
        * {
        ...
        .departure-basic-details p{font-size:1.2rem;line-height: 1.5}
        ...
        .Poi-imgDaywise{width:90%;height:400px;border:10px solid #fff;margin:auto;box-shadow: 0px 1px 5px 0px #ddd;position: relative;/*top: -100px;*/}
        .watermark {
                position: absolute;
        ...
        .Daywisebottomrightbg p{line-height:1.1;font-size:13px;}
        .btm_powered{
            position: absolute;
            bottom: 0;
            right: 0;
...
<div size="A4" style="position: relative" id="container">
    <div class="DaywiseTopbg">
        <h1>Day {{$pdf_itineraries->day_number}}</h1>
        <h2 style="color:#fff;">{{$pdf_itineraries->name}}</h2>
    ...
    <div style="width:50%;position:relative;float:left;">
        <div style="position: absolute;top: -130px;">
            ...
            <div class="dayItineraryDesc_dook">{!!$pdf_itineraries->description!!}</div>
        </div>
    </div>
        ...
        <div>
            ...
            <div style="display:block;margin-bottom:10px;width:350px;">
                ...
                <div style="display:inline-block;width:285px;vertical-align: top;">
                    <h3 style="width:280px;word-wrap: break-word;word-break: break-all;">{{$top_pois->name}}</h3>
                    <p style="width:280px;word-wrap: break-word;word-break: break-all;">{{$top_pois->address}}</p>
                </div>
            </div>
            @endforeach
        </div>
