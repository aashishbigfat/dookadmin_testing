...
<head>
    ...
    <title>Dook International</title>
    ...
    <style>
        ...
        *, ::after, ::before{
        ...
        body{font-family: 'Open Sans', sans-serif;margin:26px 0 34px;}
        .fix_pdf_container h1,.pdf_container h2,.pdf_container h3,.user_detail h2{font-family: 'Dancing Script', cursive;margin:0;padding:0;line-height:1;}
        ...
        .img{background-size: cover;background-position: center;pointer-events: none;}
        ...
        .t_promotion_img img{width:300px;}
        ...
        .bg_heading:after{width: 0;content: "";position: absolute;height: 0;top: -0.5px;right: -60px;left: 100%;border-top: 57px solid #cc2127;border-right: 33px solid transparent;}

        .day_banner{padding: 0 40px;margin-bottom:24px;}
        .day_banner .banner_img{width: 300px;height: 250px;margin-right: 10px;}
        ...
        .travel_guide:after{
            ...
            right: 0;
            left: 0;
            border-left: 430px solid #861619;
...
<body>
    @include('dom-pdf-gen-pages.header')
    @include('dom-pdf-gen-pages.footer')
    @include('dom-pdf-gen-pages.banner')
    @include('dom-pdf-gen-pages.basic_detail')
    @include('dom-pdf-gen-pages.daywise')
    @include('dom-pdf-gen-pages.inclusion')
    @include('dom-pdf-gen-pages.terms-conditions')
    @include('dom-pdf-gen-pages.contact')
    <script type="text/php">
    if ( isset($pdf) ) {
        $pdf->page_text(16, 826, "Page: {PAGE_NUM} of {PAGE_COUNT}", null, 10, array(0,0,0));
    }
</script> 
</body>
</html>