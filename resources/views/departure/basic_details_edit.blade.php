      ...
      <form role="form" id="DeparturForm">
        ...
        <div class="box-body">
          ...
          <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
            <div class="form-group">
              <label>Search Destinations </label><br>
          ...
          <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
            <div class="form-group">
              <label>Departure Cloud Destinations</label><br>
              @foreach($cloud_destination as $cloudDest)
              <span style="font-size: 16px;font-weight: bold;">@if(in_array($cloudDest->name, $destinationsss)) @else {{$cloudDest->name}} ({{$cloudDest->country_name}}), @endif</span>
              @endforeach
            </div>
          </div>
          {{--@endif --}}
        ...
        <div class="box-body">
          ...
          <div class="col-md-3 col-lg-3 col-sm-12">
            <div class="form-group">
              <label>Departure URL 1</label> <span class="validationError" id="slug_url_pre_error"></span>
              <input type="text" class="form-control" name="slug_url_pre" id="slug_url_pre" value="{{$departures->slug_url_pre}}">
            </div>
          </div>
          <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="form-group">
              <label>Departure URL 2</label> <span class="validationError" id="slug_url_error"></span>
              <input type="text" class="form-control" name="slug_url" id="slug_url" value="{{$departures->slug_url}}">
            </div>
          </div>
          <div class="col-md-3 col-lg-3 col-sm-12">
            <div class="form-group">
              <label>Departure ID</label> <span class="validationError" id="dep_dook_ref_id_error"></span>
          ...
          <div class="col-md-9">
            <div class="multiple-images" id="Filelist">
              <ul class="thumb-Images" id="imgList">
                ...
                <li>
                  <div class="img-wrap"> <span title="Remove" class="close">×</span><img class="thumb" src="{{ $urlS3.$depimg->image }}" title="{{$depimg->image}}" data-id="{{ $depimg->image }}"></div>
                  <div class="FileNameCaptionStyle">{{$depimg->image}}</div>
                </li>
                @endforeach
              </ul>
            </div>
        ...
        <div class="box-body">
          ...
          <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="form-group">
              ...
              <textarea class="form-control" name="meta_title" id="meta_title" style="height: 80px">{!! $departures->meta_title !!} </textarea>
            </div>
          </div>
          <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="form-group">
              <label>Meta Keywords</label>
              <textarea class="form-control" name="meta_keywords" id="meta_keywords" style="height: 80px">{!! $departures->meta_keywords !!}</textarea>
            </div>
          </div>
          <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="form-group">
              <label>Meta Description</label>
              <textarea class="form-control" name="meta_description" id="meta_description" style="height: 80px">{!! $departures->meta_description !!}</textarea>
            </div>
          </div>
        </div>
        <div class="box-body">
