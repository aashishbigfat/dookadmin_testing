...
@section('headSection')
@section('title', 'Departures | Inclusions Update')
...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route('departure_dates',request()->route('id'))}}">Departure Date Wise </a></li>
        <li class="active">Inclusions Edit</li>
      </ol>
    </section>
          ...
          @csrf
            <div class="box-body">
              <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-xs-12">
                <span style="font-size: 22px;"> <b>Edit Inclusions</b> </span>&nbsp; &nbsp; <span style="font-size: 18px;"> {{$dep_main->title}} | {{$dep_main->no_of_nights}}N/{{$dep_main->no_of_days}}D | {{$dep_main->dep_dook_ref_id}} </span>
              </div>
              <br>
 
            <div class="inclusion-checkbox col-md-12 col-lg-12 col-xl-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;margin-top: 35px;">
  ...
  <style type="text/css">
    .inclusionSelect_Icon,.selectedIcon input{display:none}.inclusionSelect_Icon.show{display:flex!important;flex-wrap:wrap;padding:12px 18px;box-shadow:3px 2px 6px 0 rgb(0 0 0/38%);width:100%;position:absolute;z-index:2;max-width:400px;bottom:43%;left:254px;background-color:#fff;border-radius:5px}.selectedIcon{padding:4px 6px;flex:1;max-width:36px;display:flex;align-items:center;justify-content:center}.inclusionSelect_Icon .selectedIcon img{width:24px;cursor:pointer}.inclusionSelectIcon img{width:24px;margin-right:6px}
  </style>
  @endsection
    ...
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('departure_date_inclusion_update',request()->route('date_id')) }}",
