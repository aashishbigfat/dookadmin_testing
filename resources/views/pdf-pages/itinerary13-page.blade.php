<div class="tab-pane" id="kt_tabs_6_itinerary12" role="tabpanel">
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 order-lg-12 order-xl-12">
            <form method="POST" action="{{route('add-page')}}">
                ...
                <div size="A4" style="position: relative" id="containerday1" class="pdf_container_di">
                    @foreach($itinerary_data as $itineraries)
                    @if($loop->index == 12)
                    <div class="DaywiseTopbg DaywiseTopbg13">
                    ...
                    <div style="width:50%;position:relative;float:left;">
                        <div style="position: absolute;top: -130px;">
                            <div class="Poi-imgDaywise Poi-imgDaywise13">
                                @if($itineraries->status == 0 && $itineraries->pac_image_sts == 1)
                    ...
                    <div class="Daywisebottomrightbg Daywisebottomrightbg13">
...
<head>
    ...
    /* .watermark {
        ...
        .Daywisebottomrightbg13{height: 71%;width:50%;background:#e16a61;position:relative;right:0;float: right;padding:20px;color:#fff;display: flex;align-items: center;}
        .Daywisebottomrightbg13::before{
            width: 0;
            content: "";
            position: absolute;
            height: 0;
        ...
        .Daywisebottomrightbg13 p{line-height:1.1;font-size:16px;}
        .DaywiseTopbg13::after{
            width: 0;
            content: "";
            position: absolute;
            height: 0;
        ...
        .DaywiseTopbg13 h1{font-size:2.5rem;color:#fff;}
        .DaywiseTopbg13 p{font-size:2rem;color:#fff;}
        .Poi-imgDaywise13{width:90%;height:400px;border:10px solid #fff;margin:auto;box-shadow: 0px 1px 5px 0px #ddd;position: relative;} */
    </style>
</head>
