<div class="tab-pane" id="kt_tabs_6_itinerary10" role="tabpanel">
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 order-lg-12 order-xl-12">
            <form method="POST" action="{{route('add-page')}}">
                ...
                <div size="A4" style="position: relative" id="containerday1" class="pdf_container_di">
                    @foreach($itinerary_data as $itineraries)
                    @if($loop->index == 10)
                    <div class="DaywiseTopbg DaywiseTopbg11">
                    ...
                    <div style="width:50%;position:relative;float:left;">
                        <div style="position: absolute;top: -130px;">
                            <div class="Poi-imgDaywise Poi-imgDaywise11">
                                @if($itineraries->status == 0 && $itineraries->pac_image_sts == 1)
                    ...
                    <div class="Daywisebottomrightbg Daywisebottomrightbg11">
...
<head>
    ...
    /* .watermark {
        ...
        .Daywisebottomrightbg11{height: 71%;width:50%;background:#e16a61;position:relative;right:0;float: right;padding:20px;color:#fff;display: flex;align-items: center;}
        .Daywisebottomrightbg11::before{
            width: 0;
            content: "";
            position: absolute;
            height: 0;
        ...
        .Daywisebottomrightbg11 p{line-height:1.1;font-size:16px;}
        .DaywiseTopbg11::after{
            width: 0;
            content: "";
            position: absolute;
            height: 0;
        ...
        .DaywiseTopbg11 h1{font-size:2.5rem;color:#fff;}
        .DaywiseTopbg11 p{font-size:2rem;color:#fff;}
        .Poi-imgDaywise11{width:90%;height:400px;border:10px solid #fff;margin:auto;box-shadow: 0px 1px 5px 0px #ddd;position: relative;} */
    </style>
</head>
