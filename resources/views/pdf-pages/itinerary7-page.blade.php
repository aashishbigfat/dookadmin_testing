<div class="tab-pane" id="kt_tabs_6_itinerary6" role="tabpanel">
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 order-lg-12 order-xl-12">
            <form method="POST" action="{{route('add-page')}}">
                ...
                <div size="A4" style="position: relative" id="containerday1" class="pdf_container_di">
                    @foreach($itinerary_data as $itineraries)
                    @if($loop->index == 6)
                    <div class="DaywiseTopbg DaywiseTopbg7">
                        <h1>Day{{$itineraries->day_number}}</h1>
                        <h2 style="color: #fff;font-size: 1.8rem;margin-top: 5px;">{{$itineraries->name}}</h2>
                        <div class="asdf1" style="position: absolute;bottom:-50%;z-index:10;right:5%;border:10px solid #fff;border-radius:50%;overflow: hidden;width:200px;height:200px;">
                    ...
                    <div style="width:50%;position:relative;float:left;">
                        <div style="position: absolute;top: -130px;">
                            <div class="Poi-imgDaywise Poi-imgDaywise7">
                                @if($itineraries->status == 0 && $itineraries->pac_image_sts == 1)
                    ...
                    <div class="Daywisebottomrightbg Daywisebottomrightbg7">
...
<head>
    ...
    /* .watermark {
        ...
        .Daywisebottomrightbg7{height: 71%;width:50%;background:#e16a61;position:relative;right:0;float: right;padding:20px;color:#fff;display: flex;align-items: center;}
        .Daywisebottomrightbg7::before{
            width: 0;
            content: "";
            position: absolute;
            height: 0;
        ...
        .Daywisebottomrightbg7 p{line-height:1.1;font-size:16px;}
        .DaywiseTopbg7::after{
            width: 0;
            content: "";
            position: absolute;
        ...
        .DaywiseTopbg7 h1{font-size:2.5rem;color:#fff;}
        .DaywiseTopbg7 p{font-size:2rem;color:#fff;}
        .Poi-imgDaywise7{width:90%;height:400px;border:10px solid #fff;margin:auto;box-shadow: 0px 1px 5px 0px #ddd;position: relative;} */
    </style>
</head>
