            ...
            <div class="box-body">
              <div class="col-md-3 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="opening_day" id="opening_day">
                </div>
              </div>
              <div class="col-md-3 col-lg-3 col-sm-12">
                <div class="form-group">
                  <label>Opening time</label>
                  <input type="text" class="form-control" name="opening_timing" id="opening_timing">
                </div>
              </div>
              <div class="col-md-3 col-lg-3 col-sm-12">
                <div class="form-group">
              ...
              <div class="col-md-3 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="header_email" id="header_email">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
                  <label>Address</label>
                  <textarea class="form-control" name="address" id="address" style="height: 200px"> </textarea>
                </div>
              </div>
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
