              ...
              <div class="box-body">
                  ...
                  <div class="form-group dest_add">
                    ...
                    <select class="form-control destination" name="destination" id="destination">
                      @if($destination_match)
                        <option value="{{$destination_match->id}}" selected="">{{$destination_match->dest_name}}</option>
                      @endif                                  
                    </select>
                  </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="title" value="{{$optional_activity->title}}">
                  </div>
                </div>
                <div class="col-md-3 col-lg-3 col-xl-3 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label>Duration</label> <span class="validationError" id="duration_error"></span>
                    <input type="text" class="form-control" name="duration" id="duration" value="{{$optional_activity->duration}}">
                  </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" id="description">{!! $optional_activity->description !!}</textarea>
                  </div>
                </div>
                <div class="col-md-3 col-lg-3 col-xl-3 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label>Price</label>
                    <input type="text" class="form-control" name="price" id="price" value="{{$optional_activity->price}}">
                  </div>
                </div>
                ...
                <div class="col-md-2 col-lg-2 col-sm-12">
                  <?php if($optional_activity->image == null) { ?>
                    <img id="blah" onclick="triggerImage()" src="{{asset('images/no-image.png')}}" class="" width="80" height="50"/>
                  <?php } else {?>
                    <img id="blah" onclick="triggerImage()" src="{{asset('images/uploads/optionalactivity/'.$optional_activity->image)}}" class="" width="80" height="50"/>
                  <?php } ?>
               </div>
    ...
    $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('optional_activity_update', request()->route('id')) }}",
                    data: formDatas,
                    contentType: false,
                    processData: false,
