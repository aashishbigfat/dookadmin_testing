...
class PackageCopyController extends Controller
{
	public function copyPackages(Request $request)
	{
		...
		$user = auth()->user();
		$package_data = Departure::where(['id'=> $package_id, 'dep_type'=> 'package'])->first();
        ...
        if($unique){
	        ...
	        $package->price_usd = $package_data->price_usd;
	        $package->tour_class_id = $package_data->tour_class_id;
	        ...
	        $package->visa_information = $package_data->visa_information;
	        $package->conditions = $package_data->conditions;
	        $package->tenant_id = $user->tenant_id;
	        $package->user_id = $user->id;
	        $package->dep_type = "package";
