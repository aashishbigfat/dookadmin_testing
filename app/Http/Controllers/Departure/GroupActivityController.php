...
{
    public function groupActivityIndex(Request $request)
    {
        ...
        if(count($dep_activity) > 0){
            return view('grouppackages.activity_edit',compact('activities','dep_activity','experiences'));
        }else{
            return view('grouppackages.activity_create',compact('activities','experiences'));
        }  
    }

    public function groupActivityStore(Request $request)
    {
        $data = $request->all();
        $route_ids = $request->route('id'); 
        $route_id = (int)$route_ids;
    ...
    public function groupActivityUpdate(Request $request)
    {
        $data = $request->all();
    ...
    public function getGroupExpActivityAjax(Request $request)
    {
