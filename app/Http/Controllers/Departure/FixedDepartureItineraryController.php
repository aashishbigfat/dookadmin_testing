...
class FixedDepartureItineraryController extends Controller
{
    public function departureItineraryIndex(Request $request)
    {
        $route_ids = $request->route('id'); 
        $route_id = (int)$route_ids;
        $tour = Departure::where('id',$route_id)->value('no_of_days');
        $itineraries = Itinerary::where(['departure_id' => $route_id, 'dep_type'=>'main'])
        ...
        $iti_destinations = DestinationItineraryPointOfInterest::join('departure_destination_point_of_interests','departure_destination_point_of_interests.destination_id','=','destination_itinerary_point_of_interests.destination_id')
            ...
            //dd($iti_destination) ;
        return view('departure.itinerary_create',compact('tour','itinerary','destinations','itineraries','data_dest','data_poi','iti_destinations'));
    }

    public function departureItineraryStore(Request $request)
    {
        $data = $request->all();
    ...
    public function departureItineraryUpdate(Request $request, $id)
    {
        // $data = $request->all();
    ...
    public function departureItinerayDisable(Request $request, $id)
    {
