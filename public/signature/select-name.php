...
<table cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="border:0px">
        ...
        <td>
          <table>
            <tbody>
              ...
              <tr>
                <td class="imgsimage" style="font-size: 10pt;font-family:Arial;width:124px;border:none;text-align:center;border-right:1px;" vAlign=top rowSpan=2 id="emps_image">
                ...
                <span class="signimage" id="emps_sign">
              ...
              <td>
                  ...
                  <p style="margin:0;font-weight:600;font-family:'Josefin Sans', sans-serif; text-align: left;"><span style="margin:0;font-weight:600;font-family:'Josefin Sans', sans-serif;" id="emps_name"></span> - <span style="margin:0;font-weight:600;font-family:'Josefin Sans', sans-serif;" id="designations"></span></p>
                  ...
                  <p style="margin:0;font-family:arial;font-size: 11px;margin-bottom: 5px;text-align: left;">
                    Email - <span id="emails"></span> <!-- | --> <br>
                    Visit us at :- <span id="websites"></span> <!-- <a href="" target="_blank" style="color:#551a8b" id="websites"></a> -->
                  </p>
    ...
    <div class="row">
		<button type="button" id="copyText" name="copytext" class="btn-generate btn btn-success" id="display" onclick="selectElementContents( document.getElementById('copyDiv') );">Copy Signature</button>
	</div>
